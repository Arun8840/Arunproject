...
function LandingPage() {
  ...
  return (
    <section className='bg-[#111111]  min-h-screen  grid lg:grid-cols-12 gap-2 auto-rows-max p-3'>
      {/* //todo header */}
      <div className='bg-[#4a9173] text-[#f7fd9c] backdrop-blur-sm   p-3 lg:col-span-5 flex flex-wrap gap-1 '>
      ...
      {/* demo image1 */}
      <ul className='bg-[#ada3fa]   p-2 lg:col-span-2  grid grid-cols-3 lg:grid-cols-2 place-items-center gap-1'>
      ...
      {/* demo image2 */}
      <div className='bg-[#1d1d1c]/70 border border-stone-700/20  backdrop-blur-sm   lg:col-span-2 w-full h-full'>
        <Image width={500} height={500} src={Banner_Image2} alt="profile" className='w-full h-full  object-cover' />
      </div>
      {/* //todo menu */}
      <div className='bg-[#f6d6ef] text-[#594546]  p-2 lg:col-span-3 flex items-center justify-center gap-3'>
      ...
      {/* //todo profile image */}
      <div className='bg-[#1d1d1c]/70 border border-stone-700/20  backdrop-blur-sm   lg:col-span-2'>
        <Image width={500} height={500} src={profileBanner} alt="profile" className='w-full h-full  object-cover' />
      </div>
      {/* //todo about */}
      <div className='bg-white   p-2 lg:col-span-4 text-[#020200]  '>
      ...
      {/* contact */}
      <div className='bg-[#fb7b7c]  p-2 lg:col-span-6 flex flex-col justify-between'>
      ...
      <div className='bg-[#4a9173]  p-2 lg:col-span-6 grid lg:grid-cols-3 auto-rows-max gap-3'>
