  ...
  return (
    <>
      ...
      <div ref={gridScreen} className="w-full h-full bg-black hidden opacity-0">
        <section className="bg-white dark:bg-[#101010] transition-colors duration-300  min-h-screen  grid lg:grid-cols-12 auto-rows-max gap-5  p-3">
          <>
            {/* //todo header */}
            ...
            {/* //todo settings icons */}
            <div className="bg-[#d1fe06] dark:bg-white text-[#d1fe06] w-fit mx-auto lg:w-full h-full  p-2 lg:col-span-2  grid place-items-center gap-1 rounded-3xl">
              {!darkMode ? (
                <button
                    ...
                    ProjectDatas?.map((proItems, index: number) => {
                      return (
                        <li key={index} className="p-2 ">
                          ...
                          <p
                            className={`${ContentFont?.className} capitalize tracking-wider line-clamp-2 text-sm px-2  leading-7`}
                          >
                            {proItems?.description}
                          </p>
                          <div className="flex justify-end">
                            <Link href={proItems?.path}>
                              <button className="text-sm bg-black  p-1 rounded-full text-white">
                                <RightArrow width={18} />
                              </button>{" "}
                            </Link>
                          </div>
            ...
            <div className="lg:col-span-4  flex flex-col justify-between gap-3">
              ...
              <div className="grid grid-cols-4 place-items-center bg-[white] rounded-3xl flex-1 p-3">
                {" "}
                {SkillItems?.length > 0 &&
            ...
            <div className="bg-[#D67BFF]  p-3 lg:col-span-6 flex flex-col justify-between rounded-3xl">
              ...
              >
                <input
                  type="text"
                  className="bg-white outline-none rounded-2xl bg-transparent p-3 flex-1 w-full lg:w-fit placeholder:text-black"
                  placeholder="Your Email address"
                />
                <button className="bg-[white] rounded-2xl  transition-colors duration-200 p-3 w-full lg:w-fit">
                  Get in touch !
                </button>
              </div>
            </div>
