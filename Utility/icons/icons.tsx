...
export const LightIcon=(props:any)=>{
  const { width, className } = props
  return <svg width={width} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={className}>
...
export const UnMuteIcon = (props: any) => {
  ...
  const { width, className } = props
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} width={width}>
...
export const LoaderIcon = () => {
  ...
  return (
    <svg
      className="animate-spin -ml-1 mr-3 h-5 w-5 mx-auto"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
    >
      <circle
        className="opacity-25 text-zinc-400"
        cx="12"
        cy="12"
        r="10"
        stroke="currentColor"
